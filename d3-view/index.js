...
var D3ViewGenerator = scriptBase.extend({
  ...
  writing: {
    createViewFiles: function () {
      ...
      this._writeTemplate('d3-view', path.join(this.env.options.appPath + '/scripts/views', this.name));
...
module.exports = D3ViewGenerator;
