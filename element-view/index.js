...
var ElementViewGenerator = scriptBase.extend({
  ...
  writing: {
    createViewFiles: function () {
      var templateFramework =  this.config.get('templateFramework') || 'handlebars';
      var templateExt = '.ejs';
      ...
      this._writeTemplate('element-view', path.join(this.env.options.appPath + '/scripts/views', this.name));
...
module.exports = ElementViewGenerator;
